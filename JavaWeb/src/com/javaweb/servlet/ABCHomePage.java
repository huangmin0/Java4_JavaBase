...
public class ABCHomePage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("&nbsp;&nbsp;ABCLimited founded in 1890 is a multinational company spread across six nations.<br><br> ");
		out.println("We deal with garment export and online sales of designer wares.<br><br>");
		out.println("To have a look at our fascinating collection check out at<a href='http://www.baidu.com'>ABC Designs</a></font><br><br>");
