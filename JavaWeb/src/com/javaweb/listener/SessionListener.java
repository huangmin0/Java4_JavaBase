 ...
 */
//@WebListener
public class SessionListener implements HttpSessionListener, HttpSessionAttributeListener, HttpSessionActivationListener, HttpSessionIdListener {
    ...
    public void sessionCreated(HttpSessionEvent param)  { 
        ...
        System.out.println("创建的session id="+param.getSession().getId());
    }
    ...
    public void sessionDestroyed(HttpSessionEvent paramHttpSessionEvent)  { 
        System.out.println("销毁SessionListener----sessionDestroyed");
    }
