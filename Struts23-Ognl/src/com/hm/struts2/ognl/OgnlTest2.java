...
import com.hm.struts2.ognlvaluestack.Teacher;
...
public class OgnlTest2
{
	...
	public static void main(String[] args) throws OgnlException
	{
		...
		out.println(Ognl.getValue("@com.hm.struts2.ognl.OgnlBean@staticProperty", context));
		out.println(Ognl.getValue("@com.hm.struts2.ognl.OgnlBean@staticMethod()", context));
		...
		teacherList.add(new Teacher("Jack5", 3800));
