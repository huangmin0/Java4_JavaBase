package com.hm.struts2.struts2ognl;
...
import com.hm.struts2.ognlvaluestack.Student;
...
public class OgnlAction extends ActionSupport
{
	...
	private void initData(){
		...
		String [] alias2={"laosi","四儿"};
		String [] alias3={"dalaowu","五爷"};
	...
	System.out.println("==========================");
	valueStack.set("name", "Rose");
	System.out.println(valueStack.findValue("name"));
	valueStack.set("score", "80");
	System.out.println(valueStack.findValue("score"));
	System.out.println("==========================");
	}
}
